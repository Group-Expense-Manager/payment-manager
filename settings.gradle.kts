rootProject.name = "payment-manager"
...
dependencyResolutionManagement {
    versionCatalogs {
        ...
        create("libs") {
            ...
            library("kotlinlogging", "io.github.oshai:kotlin-logging-jvm:7.0.5")
        ...
        create("testlibs") {
            ...
            library("junit", "org.junit.jupiter:junit-jupiter-engine:5.12.1")
